...
此前 15 局快速版迭代演练共清除 201 个源，平均时间为 $262.23\mathrm{s}$，中位数为 $259.59\mathrm{s}$，范围为 $197.43$--$325.96\mathrm{s}$，空清除次数为 0。
该批日志中在线决策模块的哈希前 16 位为 \texttt{2704db2749dd7700}；因其与提交版不同，只作迭代前后对照，不与正式版样本合并统计。

早期版本的官方演练中，立即调度 18 局的平均每源时间为 $507.91\mathrm{s}$；
批量调度 7 局的平均每源时间为 $418.52\mathrm{s}$，较前者降低 $17.60\%$。

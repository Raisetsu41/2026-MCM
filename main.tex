...
\usepackage{etoolbox}
\usepackage{ctex}
\setCJKfamilyfont{zhsong}[BoldFont=SimSun]{SimSun}
\setmonofont[Contextuals={Alternate},BoldFont=YaHei.Consolas.1.11b.ttf,
  ItalicFont=Fira Code Retina Nerd Font Complete.otf]{YaHei.Consolas.1.11b.ttf}
...
% 定义caption可用字体样式
\DeclareCaptionFont{figfont}{\zihao{5}}
\DeclareCaptionFont{tabfont}{\zihao{5}}

% 图标题：五号宋体
\captionsetup[figure]{
    labelfont={bf,figfont},
    textfont=figfont,
    labelsep=quad,
    format=hang
}
